    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          {/* Add your own recipe steps here! */}
          <li>Boil water.</li>
          <li>Add pasta.</li>
        ...
        <ul id="wd-your-books">
          {/* Add your own favorite books here! */}
      ...
      <div id="wd-image">
        ...
        <br />
        {/* Using the default next.svg file already in your public folder */}
        <img id="wd-local-image" src="/next.svg" width="200px" alt="Local Next.js logo" />
      </div>
      ...
      <div id="wd-anchor">
        ...
        <a id="wd-github" href="https://github.com/GautamM86/webdev-client"> click here </a>
        to navigate to your GitHub repository
      </div>
